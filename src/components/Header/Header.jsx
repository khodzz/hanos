    ...
    <header className='header'>
        ...
        <div className="container">
            ...
            <div className="logo-searcher">
              ...
              <label className='search_btn'>
                <input className='search' type="search" placeholder='Vind uw product' /><button className='search-btn'>Zoeken</button>
              </label>
            </div>
            ...
            <div className="info">
              <div className="locations">
                ...
                <a className='location__link' href="">Groothandels
                <span className='location__link_span'>Vind uw groothande</span></a>
              </div>

              <div className="add-admin">
                <img className='user-admin__img' src={user} alt="" />
                <a className='user-admin-add_link' href="">Klant worden <span className='user-admin-add_link_span'>Registreer u vandaag</span> </a>
              </div>
            </div>
        </div>
      </div>
      <div className="container contaner-bottom">
          <ul className='ul_bottom'>
              <li id='first' className="li_bottom">Acties
              </li>
